      ...
      <div className="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-lg bg-slate-800 p-5 text-sm text-white/90 shadow-2xl">
        ...
        <div className="space-y-3">
          <label className="block">
            ...
            <input id="profile-name" value={activeProfile.name} onChange={e => updateProfile({ name: e.target.value })} className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1.5 text-white"  autoComplete="off"  name="profile-name" />
          </label>

          <div className="grid grid-cols-2 gap-3">
            <label className="block">
              <span className="text-white/50">Marca</span>
              <select id="profile-brand" value={activeProfile.brand} onChange={e => updateProfile({ brand: e.target.value })} className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1.5 text-white" autoComplete="off" name="profile-brand">
            ...
            <label className="block">
              ...
              <input id="profile-model" value={activeProfile.model} onChange={e => updateProfile({ model: e.target.value })} className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1.5 text-white"  autoComplete="off"  name="profile-model" />
            </label>
          </div>
          ...
          <label className="block">
            ...
            <select id="profile-protocol" value={activeProfile.protocol} onChange={e => updateProfile({ protocol: e.target.value })}
              className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1.5 text-white" autoComplete="off" name="profile-protocol">
          ...
          <div className="grid grid-cols-2 gap-2">
            <label><span className="text-white/50">Offset X (mm)</span>
              <input id="profile-offsetX" type="number" step="0.1" min="-10" max="10" value={activeProfile.calibration?.offsetX ?? 0}
                ...
                className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white"  autoComplete="off"  name="profile-offsetX" />
            </label>
            <label><span className="text-white/50">Offset Y (mm)</span>
              <input id="profile-offsetY" type="number" step="0.1" min="-10" max="10" value={activeProfile.calibration?.offsetY ?? 0}
                ...
                className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white"  autoComplete="off"  name="profile-offsetY" />
            </label>
            <label><span className="text-white/50">Escala X</span>
              <input id="profile-scaleX" type="number" step="0.001" min="0.9" max="1.1" value={activeProfile.calibration?.scaleX ?? 1}
                ...
                className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white"  autoComplete="off"  name="profile-scaleX" />
            </label>
            <label><span className="text-white/50">Escala Y</span>
              <input id="profile-scaleY" type="number" step="0.001" min="0.9" max="1.1" value={activeProfile.calibration?.scaleY ?? 1}
                ...
                className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white"  autoComplete="off"  name="profile-scaleY" />
            </label>
            <label><span className="text-white/50">Gap entre etiquetas (mm)</span>
              <input id="profile-gap" type="number" step="0.5" min="0" max="10" value={activeProfile.calibration?.labelGap ?? 2}
                ...
                className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white"  autoComplete="off"  name="profile-gap" />
            </label>
          </div>
        </fieldset>
            ...
            <div className="space-y-2">
              <label className="block">
                ...
                <input id="profile-ip" type="text" value={printerIp} onChange={e => setPrinterIp(e.target.value)}
                  className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white" placeholder="192.168.1.100"  autoComplete="off"  name="profile-ip" />
              </label>
              <label className="block">
                ...
                <input id="profile-port" type="number" value={printerPort} onChange={e => setPrinterPort(Number(e.target.value))}
                  className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white"  autoComplete="off"  name="profile-port" />
              </label>
            ...
            <div className="space-y-2">
              <label className="block">
                ...
                <select id="profile-baud" value={baudRate} onChange={e => setBaudRate(Number(e.target.value))}
                  className="mt-1 w-full rounded border border-white/20 bg-slate-700 px-2 py-1 text-white" autoComplete="off" name="profile-baud">
