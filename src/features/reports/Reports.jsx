            ...
            <div className="mt-6 space-y-5">
              <div className="relative">
                ...
                <input
                 ...
                 autoComplete="off"  name="report-query" />
              </div>

              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                <div className="space-y-1.5">
                  <label htmlFor="report-quick-range" className="text-xs font-bold text-[#94A3B8]">Periodo</label>
                  <select id="report-quick-range" value={filters.quickRange} onChange={(e) => setQuickRange(e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30" autoComplete="off" name="report-quick-range">{quickDateRanges.map((item) => <option key={item.id} value={item.id} className="bg-[#0f172a]">{item.label}</option>)}</select>
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-date-from" className="text-xs font-bold text-[#94A3B8]">Fecha inicio</label>
                  <input id="report-date-from" type="date" value={filters.dateFrom} onChange={(e) => setFilter('dateFrom', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"  autoComplete="off"  name="report-date-from" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-date-to" className="text-xs font-bold text-[#94A3B8]">Fecha fin</label>
                  <input id="report-date-to" type="date" value={filters.dateTo} onChange={(e) => setFilter('dateTo', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"  autoComplete="off"  name="report-date-to" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-time-from" className="text-xs font-bold text-[#94A3B8]">Hora inicio</label>
                  <input id="report-time-from" type="time" value={filters.timeFrom} onChange={(e) => setFilter('timeFrom', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"  autoComplete="off"  name="report-time-from" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-time-to" className="text-xs font-bold text-[#94A3B8]">Hora fin</label>
                  <input id="report-time-to" type="time" value={filters.timeTo} onChange={(e) => setFilter('timeTo', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"  autoComplete="off"  name="report-time-to" />
                </div>
                <div className="space-y-1.5">
                  ...
                  <div className="relative">
                    ...
                    <input id="report-exact-date" type="date" value={filters.exactDate} onChange={(e) => setFilter('exactDate', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] pl-9 pr-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"  autoComplete="off"  name="report-exact-date" />
                  </div>
                </div>
              </div>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
                <div className="space-y-1.5">
                  ...
                  <input id="report-month" type="month" value={filters.month} onChange={(e) => setFilter('month', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30"  autoComplete="off"  name="report-month" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-year" className="text-xs font-bold text-[#94A3B8]">Ano</label>
                  <input id="report-year" type="number" value={filters.year} onChange={(e) => setFilter('year', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30" placeholder="2026"  autoComplete="off"  name="report-year" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-amount-min" className="text-xs font-bold text-[#94A3B8]">Monto minimo</label>
                  <input id="report-amount-min" type="number" value={filters.amountMin} onChange={(e) => setFilter('amountMin', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30" placeholder="RD$ 0"  autoComplete="off"  name="report-amount-min" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-amount-max" className="text-xs font-bold text-[#94A3B8]">Monto maximo</label>
                  <input id="report-amount-max" type="number" value={filters.amountMax} onChange={(e) => setFilter('amountMax', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30" placeholder="RD$ 999,999"  autoComplete="off"  name="report-amount-max" />
                </div>
                <div className="space-y-1.5">
                  <label htmlFor="report-status" className="text-xs font-bold text-[#94A3B8]">Estado</label>
                  <select id="report-status" value={filters.status} onChange={(e) => setFilter('status', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30" autoComplete="off" name="report-status">
                ...
                <div className="space-y-1.5">
                  ...
                  <select id="report-group-by" value={filters.groupBy} onChange={(e) => setFilter('groupBy', e.target.value)} className="h-11 w-full rounded-xl border border-[#243244] bg-[#0f172a] px-3 text-sm text-[#F8FAFC] outline-none transition focus:border-blue-500 focus:ring-1 focus:ring-blue-500/30" autoComplete="off" name="report-group-by">
            ...
            <section id="report-profit-summary" className="section-card">
              <div className="flex items-center justify-between">
                ...
                <div className="no-print flex items-center gap-2">
                  <select id="report-profit-period" value={profitPeriod} onChange={(e) => setProfitPeriod(e.target.value)} className="input-dark w-40" autoComplete="off" name="report-profit-period">
          ...
          <div className="grid gap-5 xl:grid-cols-[.75fr_1.25fr]">
            ...
            <Panel title="Acumulados por fecha">
              <div className="no-print mb-3 flex justify-end">
                <select id="report-period-select" value={periodTable} onChange={(e) => setPeriodTable(e.target.value)} className="input-dark w-36" autoComplete="off" name="report-period-select">
